...
| Owner | Action | Due | Source | Confidence |
| --- | --- | --- | --- | --- |
| Kaushik | Check with Arun regarding TMS and one finance report status. | Not stated | transcript | high |
...
| Owner | Action | Due | Source | Confidence |
| --- | --- | --- | --- | --- |
| Kaushik | Send an email to Tommy with incremental QA validation updates as promised. | Today | notes | high |
...
| Owner | Action | Due | Source | Confidence |
| --- | --- | --- | --- | --- |
| Arun | Upload all artifacts related to completed reports. | Not stated | notes | high |
...
| Owner | Action | Due | Source | Confidence |
| --- | --- | --- | --- | --- |
| Kaushik | Complete historical load for relevant tables by today. | Today | notes | high |
